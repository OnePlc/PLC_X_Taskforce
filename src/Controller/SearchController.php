<?php
/**
 * SearchController.php - Taskforce Search Controller
 *
 * Main Controller for Taskforce Search
 *
 * @category Controller
 * @package Taskforce
...
class SearchController extends CoreSearchController
{
    ...
    /**
     * Dump Taskforce data to desired format
     *
     * @return bool
     * @since 1.0.0
     */
    public function indexAction() {
         ...
         * Hooks available:
         *
         * taskforce-search-before (before show search form)
         * taskforce-search-before-execute (before query)
         * taskforce-search-after-execute (after query - before show results)
         */
        return $this->generateSearchView('taskforce');
    }
}