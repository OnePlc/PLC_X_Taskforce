<?php
/**
 * TaskforceControllerTest.php - Main Controller Test Class
 *
 * Test Class for Main Controller of Taskforce Module
 *
 * @category Test
 * @package Taskforce
...
namespace OnePlaceTest\Taskforce\Controller;

use OnePlace\Taskforce\Controller\TaskforceController;
...
class TaskforceControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/taskforce', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('taskforce');
        $this->assertControllerName(TaskforceController::class); // as specified in router's controller name alias
        $this->assertControllerClass('TaskforceController');
        $this->assertMatchedRouteName('taskforce');
    }
    ...
    public function testAddActionCanBeAccessed() {
        ...
        $this->dispatch('/taskforce/add', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('taskforce');
        $this->assertControllerName(TaskforceController::class); // as specified in router's controller name alias
        $this->assertControllerClass('TaskforceController');
    ...
    public function testEditActionCanBeAccessed() {
        ...
        $this->dispatch('/taskforce/edit/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('taskforce');
        $this->assertControllerName(TaskforceController::class); // as specified in router's controller name alias
        $this->assertControllerClass('TaskforceController');
    ...
    public function testViewActionCanBeAccessed() {
        ...
        $this->dispatch('/taskforce/view/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('taskforce');
        $this->assertControllerName(TaskforceController::class); // as specified in router's controller name alias
        $this->assertControllerClass('TaskforceController');
