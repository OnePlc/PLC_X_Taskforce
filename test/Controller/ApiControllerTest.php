...
use OnePlace\Taskforce\Controller\ApiController;
...
class ApiControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCannotBeAccessedWithoutKey() {
        $this->dispatch('/taskforce/api', 'GET');
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/taskforce/api?authkey=DEVRANDOMKEY', 'GET');
        ...
        $this->assertMatchedRouteName('taskforce-api');
    }
}
